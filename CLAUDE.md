# Family Zoo — v09 — Readable Objects — Claude Project Memory
...
**Name:** Family Zoo — v09 — Readable Objects
**Purpose:** Sharpee tutorial step 9 — Readable Objects.
...
**Repository:** https://github.com/Johnesco/familyzoo-v09
**Live:** https://johnesco.github.io/familyzoo-v09/
...
├── familyzoo-09.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v09.story`.
